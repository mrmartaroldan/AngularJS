export class Contacto {
    ...
    // Creamos una nueva instancia del tipo 'Contacto' a partir de un objeto JSON.
    ...
    // Creamos una nuevo array de instancias de tipo 'Contacto' a partir de un array de objetos JSON.
